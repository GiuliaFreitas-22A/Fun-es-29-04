// funções = bloco de código, usado para uma funcionalidade específica que só executado quando for chamado 
/*
## exemplo 1
function mensagem() {
...
## exemplo 3
 ...
 funcion potenciacao(valor1, valor2) {
    console.log(Match.pow(valor1, valor2))
 }
 ...
 let numero1 = Number(prompt("Digite o número 2:"))
 ...
 */
 ...
 funcion potenciacao(valor1, valor2) {
   return console.log(Match.pow(valor1, valor2))
 }
